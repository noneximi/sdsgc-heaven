				...
				<div id = "sortpassdiv">
					...
					<?php
						...
						if ($result->num_rows > 0) {
							...
							<div id="' . $row["CharacterName"] . 'Modal" class="modal"><div class="modal-content"><span class="close" onclick="closeButton(\'' . $row["CharacterName"] . 'Modal\')">&times;</span><p><span class="image"><img src="' .  $row["PassImageLink"] . '" alt="" /></span>' . $row["PassiveText"] . '<br><span class="image"><img src="' .  $row["CommImageLink"] . '" alt="" /></span>' . $row["CommandmentText"] . '</p></div></div></tr>';
							}
							echo '</table>';
						} else {
							echo "0 results";
